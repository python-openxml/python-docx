...
from .section import CT_HdrFtr, CT_HdrFtrRef, CT_PageMar, CT_PageSz, CT_SectPr, CT_SectType  # noqa
...
from .table import CT_TblGrid  # noqa
from .table import (
    CT_Height,
    CT_Row,
    CT_Tbl,
...
from .text.parfmt import CT_Ind, CT_Jc, CT_PPr, CT_Spacing, CT_TabStop, CT_TabStops  # noqa
