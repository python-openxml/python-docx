...
from .table import (
    CT_Row, CT_TrPr, CT_Tbl, CT_TblGrid, CT_TblGridCol, CT_TblLayoutType, CT_TblPr,
    CT_TblWidth, CT_TblHeight, CT_Tc, CT_TcPr, CT_VMerge
)
...
register_element_cls('w:trHeight',   CT_TblHeight)
